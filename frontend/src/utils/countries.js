/**
 * Countries data with dial codes
 * Data source: https://en.wikipedia.org/wiki/List_of_country_calling_codes
...
export const COUNTRIES = [
  ...
  { code: 'VG', name: 'Virgin Islands (British)', dialCode: '+1-284' },
 ...
 * @param {string} code - Country code (e.g., 'US', 'IN')
 * @returns {object|undefined} - Country object or undefined
 */
export const getCountry = (code) => COUNTRIES.find(c => c.code === code);

/**
 * Get country dial code by country code
 * @param {string} code - Country code
 * @returns {string|undefined} - Dial code or undefined
 */
